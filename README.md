...
| omada_site_to_site_vpn_connected_peers | Number of connected site-to-site VPN peers | count | direction interface_name local_ip local_peer_ip name remote_ip remote_peer_ip site site_id site_vpn_type tunnel_id vpn_id vpn_type |
| omada_site_to_site_vpn_disconnected_peers | Number of disconnected site-to-site VPN peers | count | direction interface_name local_ip local_peer_ip name remote_ip remote_peer_ip site site_id site_vpn_type tunnel_id vpn_id vpn_type |
...
| omada_site_to_site_vpn_peer_down_packets | Site-to-site VPN peer downlink traffic in packets | count | local_ip name peer_id peer_name port remote_ip site site_id site_vpn_type vpn_id vpn_type |
...
| omada_site_to_site_vpn_peer_status | The current runtime status of the site-to-site VPN peer | value | local_ip name peer_id peer_name port remote_ip site site_id site_vpn_type vpn_id vpn_type |
...
| omada_site_to_site_vpn_peer_up_packets | Site-to-site VPN peer uplink traffic in packets | count | local_ip name peer_id peer_name port remote_ip site site_id site_vpn_type vpn_id vpn_type |
